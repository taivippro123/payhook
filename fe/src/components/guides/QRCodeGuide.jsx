                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-600">Nội dung chuyển khoản (mã đơn hàng, mô tả). Phải chứa <code className="bg-gray-100 px-1 rounded text-xs">PAYHOOKxxx</code> để kích hoạt webhook</td>
                      <td className="px-4 py-3 text-sm font-mono text-gray-500">PAYHOOK123</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-900 text-gray-100 rounded-md p-4 font-mono text-sm overflow-x-auto">
                    <div className="text-blue-400">
                      ...
                      <span className="text-yellow-400">des</span>=PAYHOOK123
                    </div>
                  </div>
                  <p className="text-sm text-gray-600 mt-2">
                    QR Code này sẽ chứa thông tin: số tài khoản, ngân hàng, số tiền và nội dung chuyển khoản. 
                    Khi khách chuyển khoản với nội dung <code className="bg-gray-100 px-1 rounded text-xs">PAYHOOK123</code>, Payhook sẽ tự động bắn webhook cho đơn hàng 123.
                  </p>
                </div>
